...
func TestDomainListCmd_MockServer(t *testing.T) {
	...
	if receivedPath != "/v1/domains" {
		t.Errorf("expected /v1/domains, got %s", receivedPath)
	}
}
...
func TestDomainGetCmd_MockServer(t *testing.T) {
	...
	if receivedPath != "/v1/domains/domain-id-1" {
		t.Errorf("expected /v1/domains/domain-id-1, got %s", receivedPath)
	}
}
