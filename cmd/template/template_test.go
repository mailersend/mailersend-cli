...
func TestTemplateListCmd_MockServer(t *testing.T) {
	...
	if receivedPath != "/v1/templates" {
		t.Errorf("expected /v1/templates, got %s", receivedPath)
	}
}
...
func TestTemplateGetCmd_MockServer(t *testing.T) {
	...
	if receivedPath != "/v1/templates/tmpl-abc" {
		t.Errorf("expected /v1/templates/tmpl-abc, got %s", receivedPath)
	}
}
